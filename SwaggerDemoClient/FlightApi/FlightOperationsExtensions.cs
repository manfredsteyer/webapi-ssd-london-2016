...
namespace SwaggerDemoClient
{
    public static partial class FlightOperationsExtensions
    {
        ...
        /// Reference to the SwaggerDemoClient.IFlightOperations.
        /// </param>
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<SwaggerDemoClient.Models.Flight>> result = await operations.GetAllWithOperationResponseAsync(cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<SwaggerDemoClient.Models.Flight> result = await operations.GetByIdWithOperationResponseAsync(id, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
        ...
        {
            Microsoft.Rest.HttpOperationResponse<System.Collections.Generic.IList<SwaggerDemoClient.Models.Flight>> result = await operations.GetByRouteWithOperationResponseAsync(fromParameter, to, cancellationToken).ConfigureAwait(false);
            return result.Body;
        }
